...
SUITES=(
    ...
    "lib newton div vs GMP   |lib|test-newton-gmp|"
    "lib reduce exhaustive   |lib|test-reduce|"
    "lib arith alias-safety  |lib|test-arith-alias|"
    "lib garner CRT          |lib|test-garner|"
    "app binary_split        |app/compute_e|test-binsplit|"
    "app mem_pool            |app/compute_e|test-mempool|"
